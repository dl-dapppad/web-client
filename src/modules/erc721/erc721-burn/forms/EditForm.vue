...
const erc721 = useProductErc721Burn(route.params.contractAddress as string)
...
<template>
  <base-edit-form :heading-data="headingData" :overview="formOverviewData">
    ...
    <template #tabSecond>
      ...
      <burn-form :token="erc721" @change-balance="updateBalance" />
      <safe-transfer-form :token="erc721" @change-balance="updateBalance" />

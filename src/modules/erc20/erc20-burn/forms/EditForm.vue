...
const erc20 = useProductErc20Burn(route.params.contractAddress as string)
...
const headingData = {
  title: t('erc20-burn.title'),
  description: t('erc20-burn.description'),
  overviewLbl: t('erc20-burn.overview'),
}

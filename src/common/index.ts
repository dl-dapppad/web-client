...
export { default as ContentRender } from '@/common/ContentRender.vue'
...
export { default as GasFee } from '@/common/GasFee.vue'
export { default as ProductChecklist } from '@/common/ProductChecklist.vue'
